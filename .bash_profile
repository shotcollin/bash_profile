...
#	2.	Configure Terminal (with aliases and additional functionality)
...
#	Set color variables to simplify changing prompt colors
#	to help visibly differentiate hosts
#	------------------------------------------------------------
	# standard colors
	BLK='\033[0;30m'; RED='\033[0;31m'; GRN='\033[0;32m'; YLW='\033[0;33m'; BLU='\033[0;34m'; MAG='\033[0;35m'; CYN='\033[0;36m'; WHT='\033[0;37m'
	# bold/intense colors
	BBLK='\033[1;30m'; BRED='\033[1;31m'; BGRN='\033[1;32m'; BYLW='\033[1;33m'; BBLU='\033[1;34m'; BMAG='\033[1;35m'; BCYN='\033[1;36m'; BWHT='\033[1;37m'
	# No Color
	NC='\033[0m'
...
#	-------------------------------
	...
	alias ls='gls -h --color'					# Preferred 'ls' configuration, using coreutils ls aka gls (closer to Linux implementation of ls)
	#alias ls='ls -Gh'							# Preferred 'ls' configuration if coreutils isn't installed
...
#	sources for some things not in original gist
